...
try {
    ...
    Get-WmiObject win32_userprofile | Select-Object localpath | Where-Object { $_ -notmatch 'WINDOWS' } | ForEach-Object {
        $ZoomPath = "$($_.localpath)\AppData\Roaming\Zoom"
        # Now there is either no Zoom installed or it has been removed.
