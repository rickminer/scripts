...
* [OpenSC (tools, pkcs11 dlls, and profiles)](https://github.com/OpenSC/OpenSC/releases)
* [Hexdump (hexdump, libintl3.dll,libiconv2.dll)](http://gnuwin32.sourceforge.net/packages/hextools.htm)
